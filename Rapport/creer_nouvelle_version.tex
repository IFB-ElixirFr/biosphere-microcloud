...
Pour cela s'inspirer du script microscopeCreateDBschemas.py, copier les fichiers ainsi générés sur la VM permanente et les insérer en base.

\section{Mettre à jour les scripts côtés serveur}

Mettre à jour (si besoin) les scripts \textbf{import\_Oid.sh} et \textbf{install\_microscope.sh}.
