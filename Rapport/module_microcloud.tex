...
\begin{description}
	...
	\item[\script{import\_Oid.sh}] permet de créer un utilisateur et un schéma MySQL et d'insérer les données de l'Oid 31 (cela est nécessaire car le Web ne fonctionne pas sans données), et il permet aussi de copier les web\_data dans le répertoire approprié.
